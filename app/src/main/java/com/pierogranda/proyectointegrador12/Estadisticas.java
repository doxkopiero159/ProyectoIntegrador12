...
public class Estadisticas extends AppCompatActivity {
    ...
    private int[] sale = new int[]{12, 15, 10, 15, 14};
    ...
    public void createCharts() {
      barChart=(BarChart)getSameChart(barChart,"datos",Color.YELLOW,Color.WHITE,3000);
     ...
     barChart.invalidate();
        ...
        pieChart=(PieChart)getSameChart(pieChart,"datos2",Color.BLUE,Color.WHITE    ,3000);
    ...
    private BarData getBarData() {
        ...
        barDataSet.setBarShadowColor(Color.BLUE);
